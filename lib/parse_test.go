...
func TestParse(t *testing.T) {
	tests := map[string]struct {
		...
		"cloudbuild": {
			...
			Want: "Google Cloud Build (QUEUED) - {Images:[gcr.io/icco-cloud/relay:5fbeb676f1f3bcb622ae009200d8457f65a40afb]} @ https://console.cloud.google.com/cloud-build/builds/4996a732-a195-49dc-95e3-07d843d0e9bc?project=940380154622",
		},
		"sonarr": {
			Have: `{
  "episodes": [
